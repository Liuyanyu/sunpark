    ...
    <div class="main pad-top-40">
        <div class="container">
            <div class="page-header">
                <h2 class="page-title font-400 pad-bottom-40">游客服务中心
                </h2>
            </div>
            <div class="pad-top-40">
                <dl class="dl-list">
                    <template>
                        <p v-html="webServiceCentreCnInfo.centreContent"></p>
                    </template>
                </dl>
            </div>
        </div>
    ...
    methods: {
        query() {
            api.getCentreCn().then(res => {
                ...
                this.webServiceCentreCnInfo = object.webServiceCentreCnInfo
