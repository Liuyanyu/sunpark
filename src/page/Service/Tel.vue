    ...
    <div class="main pad-top-40">
        <div class="container">
            <div class="page-header">
                <h2 class="page-title font-400 pad-bottom-40">服务电话
                </h2>
            </div>
            <div class="pad-top-40">
                <dl class="dl-list">
                    <template>
                        <p v-html="webServiceTelCnInfo.telContent"></p>
                    </template>
                </dl>
            </div>
        </div>
    ...
    methods: {
        query() {
            api.getTelCn().then(res => {
                ...
                this.webServiceTelCnInfo = object.webServiceTelCnInfo
