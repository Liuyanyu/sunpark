    ...
    <div class="main pad-top-40">
        <div class="container">
            <div class="page-header">
                <h2 class="page-title font-400 pad-bottom-40">入园须知
                </h2>
            </div>
            <div class="pad-top-40">
                <dl class="dl-list">
                    <template>
                       <p v-html="webServiceNoticeCnInfo.noticeContent"></p>
                    </template>
                </dl>
            </div>
        </div>
    ...
    methods: {
        query() {
            api.getNoticeCn().then(res => {
                ...
                this.webServiceNoticeCnInfo = object.webServiceNoticeCnInfo
